...
<div class="container-fluid" >
	<div id="navbar_top" >
		<div  class="superNav border-bottom py-2  " style="background-color: #ee6826; columns: white;"  data-aos="fade-up">
		...
		<nav id="navbar_top"  class="navbar navbar-expand-lg bg-white  navbar-light p-4 shadow-sm " data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
		   ...
		   <div class="container-fluid">
			...
			<div id="brand">
			  <a class="navbar-brand" href="home.php"><img src="images/mainpagelogo.png" class="img-fluid " id="main-logo"> </a>	<i class="fa-solid fa-cart-shopping me-1 d-lg-none" style="color: #ee6826; cursor:pointer" data-toggle="modal" data-target="#myModalcart"></i>
				<i class="fa-solid fa-bars-staggered d-lg-none" style="color: #ee6826; cursor:pointer" id="menuicon" data-toggle="modal" data-target="#myModal"></i></div>
			  <!-- data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" -->
			  <!-- <button class="navbar-toggler" type="button"  aria-expanded="false" aria-label="Toggle navigation"> -->
				<!-- <div class="headericon">
				<i class="fa-solid fa-cart-shopping me-1 d-md-none" style="color: red;" data-toggle="modal" data-target="#myModalcart"></i>
				<i class="fa-solid fa-bars-staggered d-md-none" style="color: red;" id="menuicon" data-toggle="modal" data-target="#myModal"></i>
				</div>   -->
			  ...
			  <div class="mx-auto my-3 d-lg-none d-sm-block d-xs-block">
				 <div class="input-group">
					<span class="border-warning input-group-text   text-white" style="background:#ee6826"><i class="fa-solid fa-magnifying-glass"></i></span>
					<input type="text" class="form-control " style="color:#ee6826;border:1px solid #ee6826" >
					<button class="btn  text-white"  style="background:#ee6826">Search</button>
				 </div>
			  </div>
			  <div class=" collapse navbar-collapse" id="navbarNavDropdown">
				 <div class=" d-none d-lg-block">
					<div class="input-group">
					   <span class="border-warning input-group-text  text-white" style="background:#ee6826"><i class="fa-solid fa-magnifying-glass"></i></span>
					   <input type="text" class="form-control" style="color:#ee6826;border:1px solid #ee6826">
					   <button class="btn  text-white"  style="background:#ee6826"><i class="fa-solid fa-circle-arrow-right" style="color: white; font: 40px;"></i></button>
					</div>
				 </div>
