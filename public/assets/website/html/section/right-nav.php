					...
					<div class="modal-body">
						...
						<div class="row ">
							...
							<ul class="nav flex-column nav-link tag " id="tagmenu">
								...
								<li class="nav-item  ">
									<a class="nav-link" href="checkout.php" ><i class="fa-solid fa-cart-plus" id="rnavicon"></i> <span class="forspacing"></span> Cart</a>
								</li>


								<li class="nav-item  ">
									<a class="nav-link" href="my-profile.php" ><i class="fa-regular fa-user" id="rnavicon"></i> <span class="forspacing"></span> My Profile</a>
								</li>

								<li class="nav-item  ">
									<!-- <a class="nav-link" href="#" ><i class="fa-regular fa-file-lines"></i> <span class="forspacing"></span> Shopping Info</a> -->
									<div class="dropdown ">
										<a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">  <i class="fa-regular fa-file-lines" id="rnavicon"></i> <span class="forspacing"></span> Shopping Info</a>
								...
								<li class="nav-item  ">
									<a class="nav-link" href="contact-us.php" ><i class="fa-regular fa-message" id="rnavicon"></i> <span class="forspacing"></span> Contact Us</a>
								</li>
