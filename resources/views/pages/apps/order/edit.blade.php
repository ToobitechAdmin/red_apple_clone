    ...
    @section('breadcrumbs')
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('slider.index') }}">Category Management</a></li>
                ...
                <div class="card-body py-4 mx-20">
                    ...
                    <form action="{{ route('category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fw-semibold fs-6 mb-2">Category File</label>
                            <!--end::Label-->
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--begin::Input-->
                            <input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Enter Title" value="{{ $category->name }}" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
