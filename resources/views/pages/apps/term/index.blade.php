<x-default-layout>
    ...
    @endsection
    @section('breadcrumbs')
        {{ Breadcrumbs::render('term-condition.index') }}
    @endsection
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="px-7 py-5" data-kt-user-table-filter="form">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        ...
                        <i class="ki-duotone ki-plus fs-2"></i> Add Terms and Conditions
                    </button>
                    @endif
                    @if(!isset($term[0]))
                    <!--begin::Add user-->
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                <!--begin::Form-->
                                <form id="kt_modal_export_users_form" class="form" action="{{ route('term-condition.store') }}"
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body px-5 my-7">
                                <!--begin::Form-->
                                <form id="kt_modal_add_user_form" class="form" action="{{ route('term-condition.store') }}"
                                    method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="required fw-semibold fs-6 mb-2" name="paragraph">Paragraph</label>
                                            <!--end::Label-->

                                            <!--begin::Input-->
                                            <textarea name="paragraph" id="editor" class="editor form-control form-control-solid mb-3 mb-lg-0" placeholder="Enter Paragraph"></textarea>
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                    ...
                    <tbody class="text-gray-600 fw-semibold">
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <form action="{{ route('term-condition.destroy', $term->id) }}" method="post"
                                ...
                                <form action="{{ route('term-condition.edit', $term->id) }}" method="get"
                                    style="display:inline">
                                    @csrf
