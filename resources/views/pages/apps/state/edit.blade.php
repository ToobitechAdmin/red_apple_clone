    ...
    @section('breadcrumbs')
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('state.index') }}">State Management</a></li>
                ...
                <div class="card-body py-4 mx-20">
                    ...
                    <form action="{{ route('state.update', $state->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--begin::Input-->
                            <input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Enter Name" value="{{ $state->name }}" />
                            <!--end::Input-->
                        </div>
