<x-default-layout>
    ...
    @endsection
    @section('breadcrumbs')
        {{ Breadcrumbs::render('return-refund.index') }}
    @endsection
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="px-7 py-5" data-kt-user-table-filter="form">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        ...
                        <i class="ki-duotone ki-plus fs-2"></i> Add Policies
                    </button>
                    @endif
                    @if(!isset($refund[0]))
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                ...
                                <form id="kt_modal_export_users_form" class="form"
                                    action="{{ route('return-refund.store') }}" method="POST"
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_add_user_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">Add Policies</h2>
                                <!--end::Modal title-->
                                ...
                                <form id="kt_modal_add_user_form" class="form"
                                    ...
                                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--begin::Input-->
                                            <textarea name="paragraph" id="editor" class="editor form-control form-control-solid mb-3 mb-lg-0"
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                    ...
                    <tbody class="text-gray-600 fw-semibold">
                        ...
                        <tr>
                            ...
                            <td>{!! $refund->paragraph !!}</td>

                            <td class="actions">
                                <form action="{{ route('return-refund.destroy', $refund->id) }}" method="post"
                                ...
                                <form action="{{ route('return-refund.edit', $refund->id) }}" method="get"
                                    style="display:inline">
                                    @csrf
