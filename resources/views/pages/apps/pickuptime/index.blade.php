<x-default-layout>
    ...
    @endsection
    @section('breadcrumbs')
        {{ Breadcrumbs::render('pickup-time.index') }}
    @endsection
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" id="userSearchInput" class="form-control form-control-solid w-250px ps-13"
                            placeholder="Search Pickup Time" />
                    </div>
                    <!--end::Search-->
                </div>
                ...
                {{-- <div class="px-7 py-5" data-kt-user-table-filter="form">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        ...
                        <i class="ki-duotone ki-plus fs-2"></i> Add Pickup Time
                    </button>
                    <!--end::Add user-->
                </div> --}}
                <!--end::Toolbar-->
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                <!--begin::Form-->
                                <form id="kt_modal_export_users_form" class="form" action="{{ route('pickup-time.store') }}"
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_add_user_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">Add Pickup Time</h2>
                                <!--end::Modal title-->
                            ...
                            <div class="modal-body px-5 my-7">
                                <!--begin::Form-->
                                <form id="kt_modal_add_user_form" class="form" action="{{ route('pickup-time.store') }}"
                                    method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="required fw-semibold fs-6 mb-2" name="opening_time">Opening Time</label>
                                            <!--end::Label-->
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="required fw-semibold fs-6 mb-2" name="closing_time">Closing Time</label>
                                            <!--end::Label-->

                                            <!--begin::Input-->
                                            <input type="text" name="closing_time"
                                                class="form-control form-control-solid mb-3 mb-lg-0"
                    ...
                    <tbody class="text-gray-600 fw-semibold">
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <form action="{{ route('pickup-time.edit', $pickup->id) }}" method="get"
                                    style="display:inline">
                                    @csrf
