<x-default-layout>
    ...
    @endsection
    @section('breadcrumbs')
        {{ Breadcrumbs::render('privacy-policy.index') }}
    @endsection
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                ...
                                <form id="kt_modal_export_users_form" class="form"
                                    action="{{ route('privacy-policy.store') }}" method="POST"
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header" id="kt_modal_add_user_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">Add Privacy and Policy</h2>
                                <!--end::Modal title-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                    ...
                    <tbody class="text-gray-600 fw-semibold">
                        ...
                        <tr>
                            ...
                            <td>{!! $privacy->paragraph !!}</td>

                            <td class="actions">
                                <form action="{{ route('privacy-policy.destroy', $privacy->id) }}" method="post"
                                ...
                                <form action="{{ route('privacy-policy.edit', $privacy->id) }}" method="get"
                                    style="display:inline">
                                    @csrf
