            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        <h2 class="fw-bold">Edit Privacy & Policy</h2>
                    </div>
                </div>
                <!--end::Card header-->
                ...
                <div class="card-body py-4 mx-20">
                    ...
                    <form action="{{ route('privacy-policy.update', $privacy->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--begin::Input-->
                            <textarea name="paragraph" id="editor" class="editor form-control form-control-solid mb-3 mb-lg-0" placeholder="Enter Paragraph" value="{!! $privacy->paragraph !!}"></textarea>
                            <!--end::Input-->
                        </div>
