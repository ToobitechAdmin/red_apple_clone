        ...
        <div id="navbar_top">
            ...
            <div class="superNav border-bottom py-2  " style="background-color: #ee6826; columns: white;"
                ...
                <marquee behavior="" direction="" style="color: white; font-weight: 600; font-size:17px">
                    GINO GINELLES is currently {{ $status['store_status'] ?? '' }} and will {{ $status['reverse_status'] ?? '' }}
                    shortly at {{\Carbon\Carbon::parse($status['time'])->format('g:i A')}} for new orders.
                </marquee>
            </div>
            <nav id="navbar_top" class="navbar navbar-expand-lg bg-white  navbar-light p-4 shadow-sm " data-aos="fade-up"
                    ...
                    <div class="mx-auto my-3 d-lg-none d-sm-block d-xs-block">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control "
                                style="border:1px solid #ee6826 ; color:#7a7a7a">
