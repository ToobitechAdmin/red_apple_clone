                ...
                <div class="otpp" id="">
                    <div class="container height-100 d-flex justify-content-center align-items-center">
                        <div class="position-relative">
                            <div class="text-center"><i class="fa-solid fa-arrow-left" id="backkk"></i><span
                                    style="margin-left:20px"> <strong> Enter your Chikoo pin</strong> </span></div>
                            <div class="cardddd p-2 text-center">
                                ...
                                <div id="otp" class="inputs d-flex flex-row justify-content-center mt-2"> <input
                                        ...
                                        maxlength="1" /> </div>
                                <div class="mt-4"> <button class="btn btn-secondary px-4 validate"
                                        id="login">Login</button> </div>
                                <div class="mt-4"> <button
                                        class="btn btn-danger px-4 validate"id="forget">Forget</button> </div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container height-100 d-flex justify-content-center align-items-center">
                        <div class="position-relative">
                            ...
                            <div class="cardddd p-2 text-center">
                                ...
                                <h6 class="text-center">We have sent you an OTP. Verify the OTP and retrieve your name,
                                    <br>address and payment details for a quick checkout.
                                </h6>
                                ...
                                <div id="otp" class="inputs d-flex flex-row justify-content-center mt-2"> <input
                                        ...
                                        maxlength="1" /> <input class="m-2 text-center form-control rounded"
                                        type="text" id="fourth" maxlength="1" /></div>

                                <h5> <strong> Couldn’t verify the OTP? </strong></h5>
                                <button class="btn btn-secondary" disabled>Limit exceeded for SMS retries.</button>
                                <span><Strong> Or </Strong></span> <span> <strong>Request a Call</strong> </span>

                                <div class="mt-4"> <button class="btn btn-secondary px-4 validate">Reset Pin</button>
                                </div>
                                <div class="mt-4"> <button class="btn btn-danger px-4 validate" id="backtologin">Back
                                        Login</button> </div>
                            </div>
                        </div>
                    </div>
