					...
					<div class="modal-body">
						...
						<div class="row ">
							...
							<ul class="nav flex-column nav-link tag " id="tagmenu">
								...
								<li class="nav-item  ">
									<a class="nav-link" href="home.php" ><i class="fa-solid fa-house"></i> <span class="forspacing"></span> Home</a>
								</li>

								<li class="nav-item  ">
									<a class="nav-link" href="checkout.php" ><i class="fa-solid fa-cart-plus"></i> <span class="forspacing"></span> Cart</a>
								</li>
								...
								<li class="nav-item  ">
									...
									<div class="dropdown ">
										<a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">  <i class="fa-regular fa-file-lines"></i> <span class="forspacing"></span> Shopping Info</a>
								...
								<li class="nav-item  ">
									<a class="nav-link" href="contact-us.php" ><i class="fa-regular fa-message"></i> <span class="forspacing"></span> Contact Us</a>
								</li>
