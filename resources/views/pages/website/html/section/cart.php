								...
								<table class="table table-borderless table-responsive">
									...
									<tbody>
									  <tr>
										...
										<td class=" w-50"><div class="img-withdesc"> <img src="{{ asset('assets/website/images/mainpagelogo.png') }}" class="img-fluid w-25" alt=""> <div class="descr"> meethi puri <span class="badge badge-secondary"><i class="fa-solid fa-trash"></i> remove</span>  </div></div></td>
										...
										<td style="vertical-align: top; "><div style="margin-top:15px">300</div></td>
									  </tr>
