...
<div class="container-fluid rpt">
            <h2 id="tphd">Returns Policy</h2>
            <p id="rptp">Please read through our Return Policy on this page to understand our return procedures and make sure your item is eligible for return. You will have 7 days after an item is delivered to you to notify us that you want to return the item. This means if your item was delivered e.g. on the 5th of the month, you have till the 12th to initiate a return. If the item you wish to return meets the criteria mentioned below, your return can be initiated by calling our helpline at (021) 111-111-733 which is available 24/7

            </p>

            <h4 id="rptheading">How to Request a Return?</h4>
            <p id="rptp"> You can request to initiate a return by contacting our helpline at (021) 111-111-733 to confirm that your product is eligible for return. We will explain to you the return procedure, and confirm the nearest service provider location where you can drop-off the product. Please be prepared to give the following pieces of information: <Your order number> and <The reason for the return>. The method of refund that you would like and the necessary information associated (bank account number, etc.).
            </p>
